...
class DFS_hungary():
    ...
    def path(self, u):
        for v in self.ny:
            print(u, v, self.edge[u][v], self.visited[v])
...
if __name__ == '__main__':
    ...
    edge = {'A':{'E': 1, 'F': 1, 'G': 1, 'H':1}, 'B':{'E': 1, 'F': 0, 'G': 0, 'H':0}, 'C':{'E': 1, 'F': 1, 'G': 1, 'H':1}, 'D':{'E': 1, 'F': 1, 'G': 1, 'H':1}}                                                 # 1 表示可以匹配， 0 表示不能匹配    
